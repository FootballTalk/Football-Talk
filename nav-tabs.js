document.addEventListener('DOMContentLoaded',()=>{
  ...
  style.textContent=`
    .quick-nav{position:sticky!important;top:0!important;z-index:90!important;background:#0b0b0e!important;border-bottom:1px solid #2b2b31!important;display:grid!important;grid-template-columns:repeat(6,minmax(0,1fr))!important;gap:0!important;padding:0 10px!important;box-shadow:0 4px 16px rgba(0,0,0,.16)!important}.quick-nav a{position:relative!important;display:flex!important;align-items:center!important;justify-content:center!important;text-align:center!important;min-width:0!important;background:transparent!important;color:#fff!important;border:0!important;border-radius:0!important;padding:13px 8px 15px!important;font-weight:900!important;font-size:13px!important;text-decoration:none!important;white-space:nowrap!important}.quick-nav a:hover,.quick-nav a:focus-visible{background:#17171b!important}.quick-nav a.active-tab{color:#f7c600!important}.quick-nav a.active-tab::after{content:'';position:absolute;left:10px;right:10px;bottom:0;height:4px;background:#f7c600}.nav a[data-main-nav="members"]{color:#f7c600!important;font-weight:1000!important}.nav a.active-tab{color:#f7c600!important}.auto-hidden{display:none!important}
    @media(max-width:900px){html{scroll-padding-top:118px!important}.quick-nav{display:flex!important;grid-template-columns:none!important;justify-content:flex-start!important;overflow-x:auto!important;overscroll-behavior-x:contain!important;scroll-snap-type:x proximity!important;scrollbar-width:none!important;-webkit-overflow-scrolling:touch!important;padding:0 5px!important}.quick-nav::-webkit-scrollbar{display:none!important}.quick-nav a{flex:0 0 auto!important;min-width:auto!important;padding:11px 13px 13px!important;font-size:11px!important;line-height:1!important;scroll-snap-align:start!important}.quick-nav a.active-tab::after{left:10px;right:10px;height:3px}.nav{max-height:calc(100vh - 70px);overflow:auto}.nav a{font-size:16px!important;padding:14px 18px!important}.top-social{justify-content:center!important;padding:7px 10px!important;gap:6px!important}.top-social>span{display:none!important}.top-social a.social-icon{width:34px!important;height:34px!important;min-width:34px!important;font-size:18px!important}.member-home-cta{margin:7px auto!important;padding:0 10px!important}.member-home-card{padding:13px 14px!important;border-radius:12px!important}.member-home-card .eyebrow{font-size:10px!important;margin-bottom:3px!important}.member-home-card h2{font-size:20px!important;margin-bottom:4px!important}.member-home-card p{font-size:13px!important;line-height:1.4!important}.member-home-button{margin-top:10px!important;padding:11px 14px!important;min-width:0!important;font-size:13px!important}.ticker-label{padding:7px 5vw!important;font-size:12px!important}.ticker-viewport{height:39px!important}.ticker-track span{padding:9px 20px!important}.hero{min-height:420px!important;padding-top:48px!important;padding-bottom:48px!important}.section{scroll-margin-top:118px!important}}
