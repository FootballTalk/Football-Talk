document.addEventListener('DOMContentLoaded',()=>{
  ...
  const sections=[
    ...
    {key:'transfers',label:'Transfers',href:'section.html?view=transfers'},
  ...
  const currentKey=()=>{
    ...
    if(path==='news.html'||(path==='section.html'&&['latest','debate'].includes(view)))return'news';
  ...
  style.textContent=`
    .quick-nav{position:sticky!important;top:0!important;z-index:90!important;background:#0b0b0e!important;border-bottom:1px solid #2b2b31!important;display:grid!important;grid-template-columns:repeat(7,minmax(0,1fr))!important;gap:0!important;padding:0 10px!important}.quick-nav a{position:relative!important;display:flex!important;align-items:center!important;justify-content:center!important;text-align:center!important;min-width:0!important;background:transparent!important;color:#fff!important;border:0!important;border-radius:0!important;padding:14px 8px 16px!important;font-weight:900!important;font-size:13px!important;text-decoration:none!important}.quick-nav a:hover,.quick-nav a:focus-visible{background:#17171b!important}.quick-nav a.active-tab{color:#f7c600!important}.quick-nav a.active-tab::after{content:'';position:absolute;left:10px;right:10px;bottom:0;height:5px;background:#f7c600}.nav a[data-main-nav="members"]{color:#f7c600!important;font-weight:1000!important}.nav a.active-tab{color:#f7c600!important}.auto-hidden{display:none!important}
