...
(function () {
  var foundingPackage = 'Founding Commercial Partner — £1,500 / 12 months';
  ...
  function addFoundingPartnerStyles() {
    ...
    style.textContent = [
      ...
      '@media(min-width:901px){.site-header{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(520px,.95fr);gap:28px;align-items:center}.site-header>.desktop-hero-brand{max-width:none!important}.site-header>#founding-partners{display:block!important;background:transparent;border:0;overflow:visible}.site-header>#founding-partners .ft-founding-inner{padding:10px 0;max-width:none}.site-header>#founding-partners .ft-founding-top{grid-template-columns:minmax(0,1fr) auto;gap:12px}.site-header>#founding-partners .ft-founding-kicker{font-size:9px;margin-bottom:3px}.site-header>#founding-partners h2{font-size:26px}.site-header>#founding-partners .ft-founding-copy{display:none}.site-header>#founding-partners .ft-founding-btn{font-size:10px;padding:9px 11px;border-radius:5px}.site-header>#founding-partners .ft-founding-slots{gap:4px;margin-top:8px}.site-header>#founding-partners .ft-founding-slot{font-size:8px;padding:7px 4px;border-radius:5px;letter-spacing:0}}'
    ].join('');
