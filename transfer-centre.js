(()=>{
  ...
  .ft-tc-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.ft-tc-card{background:#fff;border-radius:14px;border:1px solid #ddd;overflow:hidden;box-shadow:0 5px 16px rgba(0,0,0,.05)}.ft-tc-media{aspect-ratio:16/9;overflow:hidden;background:#111;border-bottom:3px solid #f7c600}.ft-tc-media img{display:block;width:100%;height:100%;object-fit:cover}.ft-tc-card-head{display:flex;gap:12px;align-items:flex-start;padding:14px 15px 11px}.ft-tc-stage{display:inline-block;background:#111;color:#fff;border-radius:999px;padding:5px 8px;font-size:10px;font-weight:1000;letter-spacing:.05em}.ft-tc-stage.go,.ft-tc-stage.official{background:#f7c600;color:#070707}.ft-tc-title{font-weight:950;line-height:1.25;margin:7px 0 0}.ft-tc-desc{padding:0 15px 12px;color:#555;font-size:12px;line-height:1.4}.ft-tc-rail{display:grid;grid-template-columns:repeat(4,1fr);gap:4px;padding:0 15px 14px}.ft-tc-step{text-align:center;position:relative}.ft-tc-step:before{content:'';display:block;height:5px;border-radius:4px;background:#ddd;margin-bottom:5px}.ft-tc-step.done:before,.ft-tc-step.current:before{background:#f7c600}.ft-tc-step small{font-size:8px;font-weight:950;color:#999}.ft-tc-step.done small,.ft-tc-step.current small{color:#111}.ft-tc-link{display:block;text-decoration:none!important;color:inherit}.ft-tc-empty{background:#fff;border-radius:12px;padding:22px;text-align:center;color:#666}
  @media(max-width:760px){.ft-tc-shell{padding:14px}.ft-tc-head{display:block}.ft-tc-updated{margin-top:8px}.ft-tc-grid{grid-template-columns:1fr}.ft-tc-legend span{font-size:9px;padding:8px 3px}}
  `;
  ...
  function addPublishedImage(card,item){
    ...
    img.decoding='async';
    img.onload=()=>{
      if(img.naturalWidth<500||img.naturalHeight<280)return;
      const media=document.createElement('div');
      media.className='ft-tc-media';
