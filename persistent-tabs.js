(() => {
  ...
  function build(){
    ...
    if(!tabs){
      ...
      [...tabs.querySelectorAll('a')].filter(a=>(a.getAttribute('href')||'').toLowerCase()==='account.html').forEach(a=>a.remove());
      if(![...tabs.querySelectorAll('a')].some(a=>(a.getAttribute('href')||'').toLowerCase()==='members.html')){
        const a=document.createElement('a');a.href='members.html';a.textContent='🔒 Members Area';tabs.appendChild(a);
      }
    }
    ...
    if(!document.getElementById('ft-persistent-tabs-style')){
      ...
      style.textContent=`.ft-persistent-tabs{position:sticky!important;top:var(--ft-tabs-top,76px)!important;z-index:175!important;display:flex!important;flex-wrap:wrap!important;justify-content:center!important;align-items:stretch!important;gap:0!important;padding:0 8px!important;background:#0b0b0e!important;border-bottom:1px solid #2b2b31!important;box-shadow:0 3px 10px rgba(0,0,0,.14)!important}.ft-persistent-tabs a{position:relative!important;flex:1 1 130px!important;max-width:190px!important;min-width:105px!important;text-align:center!important;background:transparent!important;color:#fff!important;border:0!important;padding:12px 10px 14px!important;font-size:12px!important;line-height:1.1!important;font-weight:900!important;text-decoration:none!important}.ft-persistent-tabs a[href="members.html"]{font-size:14px!important;color:#f7c600!important;max-width:215px!important}.ft-persistent-tabs a:hover,.ft-persistent-tabs a:focus-visible{background:#17171b!important;color:#fff!important}.ft-persistent-tabs a.active-tab::after{content:'';position:absolute;left:7px;right:7px;bottom:0;height:4px;background:#f7c600}@media(max-width:900px){.ft-persistent-tabs{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;padding:0 4px!important}.ft-persistent-tabs a{min-width:0!important;max-width:none!important;width:100%!important;padding:10px 3px 12px!important;font-size:10.5px!important}.ft-persistent-tabs a[href="members.html"]{font-size:12.5px!important;grid-column:4}.ft-persistent-tabs a.active-tab::after{left:4px;right:4px}}`;
